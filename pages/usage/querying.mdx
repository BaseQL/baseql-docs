...
BaseQL currently supports other standard GraphQL fatures such as [Aliases](https://graphql.org/learn/queries/#aliases),  [Fragments](https://graphql.org/learn/queries/#fragments), [Operation Names](https://graphql.org/learn/queries/#operation-name) and [Variables](https://graphql.org/learn/queries/#variables):
